...
echo (3) Install Java development kit se (gonna be depricated soon)
...
if /i "%choice%"=="4" (
    echo Opening script...
    start "" "%ScriptDir%Scripts\Script2.bat"
)

if /i "%choice%"=="5" (
    echo Opening script...
    start "" "%ScriptDir%Scripts\Script4.bat"
)

if /i "%choice%"=="6" (
    echo Opening script...
    start "" "%ScriptDir%Scripts\Script3.bat"
)


if /i "%choice%"=="7" (
    echo Opening script...
    start "" "%ScriptDir%Scripts\EulaGen.bat"
)
