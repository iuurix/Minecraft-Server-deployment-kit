...
echo Plugins
echo (1) Glowstone
echo (2) PaperMC 1.21.4
echo (P) PaperMC 1.21.5
echo (3) Pufferfish
echo (4) Purpur
...
set /p choice=Enter your choice (1-9, B, P or C):
...
if /i "%choice%"=="P" (
    echo Opening script...
    start "" "%ScriptDir%..\BackendServer\jarinstallers\PaperMC - 1.21.5 experimental.bat"
)
