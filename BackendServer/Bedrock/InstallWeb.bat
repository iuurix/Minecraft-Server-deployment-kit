...
set JAR_URL=https://www.minecraft.net/bedrockdedicatedserver/bin-win/bedrock-server-1.21.102.1.zip

set DestinationFolder=%ScriptDir%

set JAR_File=%TEMP%\bedrock-server-1.21.zip
...
if exist "%JAR_File%" (
    ...
    move "%JAR_File%" "%DestinationFolder%\bedrock-server-1.21.zip"
