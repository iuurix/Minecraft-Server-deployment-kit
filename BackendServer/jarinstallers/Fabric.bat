...
set JAR_URL=https://meta.fabricmc.net/v2/versions/loader/1.21.7/0.16.14/1.0.3/server/jar

set DestinationFolder=%ScriptDir%..\..\DeployedServer

set JAR_File=%TEMP%\fabric-server-mc.1.21.7-loader.0.16.14-launcher.1.0.3.jar
...
if exist "%JAR_File%" (
    ...
    move "%JAR_File%" "%DestinationFolder%\fabric-server-mc.1.21.7-loader.0.16.14-launcher.1.0.3.jar"
