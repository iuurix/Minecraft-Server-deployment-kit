...
set JAR_URL=https://github.com/IzzelAliz/Arclight/releases/download/FeudalKings%2F1.0.0/arclight-neoforge-1.21.1-1.0.0-3457560.jar

set DestinationFolder=%ScriptDir%..\..\DeployedServer

set JAR_File=%TEMP%\arclight-neoforge-1.21.1-1.0.0-3457560.jar
