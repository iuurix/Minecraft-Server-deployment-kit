...
set JAR_URL=https://github.com/ViaVersion/ViaProxy/releases/download/v3.4.1/ViaProxy-3.4.1.jar

set DestinationFolder=%ScriptDir%..\..\DeployedServer

set JAR_File=%TEMP%\ViaProxy-3.4.1.jar
...
if exist "%JAR_File%" (
    ...
    move "%JAR_File%" "%DestinationFolder%\ViaProxy-3.4.1.jar"
