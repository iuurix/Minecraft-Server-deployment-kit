...
set JAR_URL=https://api.papermc.io/v2/projects/velocity/versions/3.4.0-SNAPSHOT/builds/509/downloads/velocity-3.4.0-SNAPSHOT-509.jar

set DestinationFolder=%ScriptDir%..\..\DeployedServer

set JAR_File=%TEMP%\velocity-3.4.0-SNAPSHOT-509.jar
...
if exist "%JAR_File%" (
    ...
    move "%JAR_File%" "%DestinationFolder%\velocity-3.4.0-SNAPSHOT-509.jar"
